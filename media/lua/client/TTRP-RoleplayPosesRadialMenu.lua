...
function StandingLean(menu)
    ...
    menu:addSlice("Lean - Glass Box of Emotion", getTexture("media/ui/poses/standing/noicon.png"), doEmote, "TTRP_GlassBoxOfEmotion")
    menu:addSlice("Lean - Cleaning Gun/Racking Gun", getTexture("media/ui/poses/standing/noicon.png"), doEmote, "TTRP_Clean_Pistol")
    menu:addSlice("Lean - Lean On Table Left", getTexture("media/ui/poses/standing/noicon.png"), doEmote, "TTRP_LeanLeftTable")
    menu:addSlice("Lean - Lean On Table Right", getTexture("media/ui/poses/standing/noicon.png"), doEmote, "TTRP_LeanRightTable")
    end
...
function Standing(menu)
    ...
    menu:addSlice("Stand - Hold Vest Straps", getTexture("media/ui/poses/standing/noicon.png"), doEmote, "TTRP_HoldVest")
end
...
function SittingObject(menu)
    ...
    menu:addSlice("Sit In Chair - Forearms on Thighs", getTexture("media/ui/poses/sitting/deep-squat.png"), doEmote, "TTRP_Sitting_ForearmsThighs")
...
-- Prop emotes menu
  ...
  menu:addSlice("Stand - Holding Gun Idle", getTexture("media/ui/poses/props/pistolsteady.png"), doEmote, "TTRP_HoldPistol")
  ...
  menu:addSlice("Stand - Weapon on Shoulder", getTexture("media/ui/poses/props/noicon.png"), doEmote, "TTRP_Weapon-Shoulder")
end
